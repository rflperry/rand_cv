...
```
git clone https://github.com/rflperry/rand_cv.git
cd rand_cv
uv pip install .
```
...
1. Fork the [project repository](https://github.com/rflperry/rand_cv) by clicking on the ‘Fork’ button near the top
...
2. Clone your fork of the repo from your GitHub account to your local disk:
   ...
   ```sh
   git clone git@github.com:YourGithubAccount/rand_cv.git
   cd rand_cv
   ```
